// src/pages/ConditionIdentifier.jsx
...
const ConditionIdentifier = () => {
  ...
  // Simulate file upload progress (local UI only)
  const uploadFile = (file) => {
    return new Promise((resolve) => {
      ...
      }, 200); // speed of the "fake" progress
    });
  };
  ...
  const handleFiles = (newFiles) => {
    ...
    // Start the "upload" simulation for each
    ...
    <div className="w-full">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold mb-2">
          Upload leaf images for our
          <span className="text-green-600"> Condition Detection </span>
        </h1>
      </div>
      ...
      <AnimatePresence>
        ...
        {/* "Analyze" Button: link to /condition-analyze, sending files in router state */}
        {files.length > 0 && (
          <motion.div
...
export default ConditionIdentifier;
