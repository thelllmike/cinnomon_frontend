    ...
    <div className="w-full">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold mb-2">
          Upload your cinnamon stick images for 
          <span className="text-green-600"> Stick Disease Detection</span>
        </h1>
      </div>
...
export default StickDiseaseIdentifier;
